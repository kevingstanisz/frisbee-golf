  ...
  return (
    <main className="max-w-xl mx-auto px-4 py-8">
      <div style={{ marginBottom: '0.5rem' }}>
        <a href="/courses" style={{ color: 'rgba(240,237,232,0.4)', fontSize: '0.9rem', textDecoration: 'none' }}>
          ← Courses
        </a>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        {/* Name */}
        <div>
          <label style={{ display: 'block', fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '0.08em', color: 'rgba(240,237,232,0.5)', marginBottom: '0.5rem' }}>
            Course Name
          </label>
        ...
        <div>
          ...
          <input
            type="text"
            value={holes}
            onChange={(e) => setHoles(Number(e.target.value) || 18)}
            style={{ width: '6rem' }}
          />
        </div>
