...
BEGIN
  ...
  -- Woodridge Standard
  INSERT INTO rounds (course_config_id) VALUES (cfg_woodridge) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_dan, -7), (r, p_frank, -6), (r, p_kevin, -4), (r, p_zack, -2);

  -- Kress Creek A
  INSERT INTO rounds (course_config_id) VALUES (cfg_kress) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_frank, -6), (r, p_zack, -5), (r, p_kevin, -3);

  -- Oaks White
  INSERT INTO rounds (course_config_id) VALUES (cfg_oaks) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_dan, 0), (r, p_frank, 1), (r, p_kevin, 2), (r, p_zack, 7);

  -- Naperville B White
  INSERT INTO rounds (course_config_id) VALUES (cfg_nap_b) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_zack, 2), (r, p_frank, 3), (r, p_kevin, 4), (r, p_dan, 5);

  -- Naperville A White
  INSERT INTO rounds (course_config_id) VALUES (cfg_nap_a) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_dan, 1), (r, p_frank, 1), (r, p_zack, 6);

  -- Piltcher White A
  INSERT INTO rounds (course_config_id) VALUES (cfg_piltcher) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_frank, 3), (r, p_dan, 4), (r, p_zack, 5), (r, p_kevin, 8), (r, p_david, 16);

  -- Canyons Blue A
  INSERT INTO rounds (course_config_id) VALUES (cfg_canyons) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_frank, 3), (r, p_kevin, 11);

  -- Maryknoll Park - Glen Ellyn all par 3s
  INSERT INTO rounds (course_config_id) VALUES (cfg_maryknoll) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_kevin, -3), (r, p_frank, -2), (r, p_zack, 0), (r, p_david, 4);

  -- Rotary Park - White numbers
  INSERT INTO rounds (course_config_id) VALUES (cfg_rotary) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_frank, 3);

  -- Channahon White A (hole 2 B)
  INSERT INTO rounds (course_config_id) VALUES (cfg_channahon_1) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_frank, -5), (r, p_david, -3);

  -- Channahon White A UDisc
  INSERT INTO rounds (course_config_id) VALUES (cfg_channahon_2) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_kevin, 2), (r, p_zack, 7);

  -- Shorewood Park - Red all 3s
  INSERT INTO rounds (course_config_id) VALUES (cfg_shorewood) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_frank, -6), (r, p_kevin, -2), (r, p_zack, -2);

  -- Katherine Legge - Hinsdale numbers
  INSERT INTO rounds (course_config_id) VALUES (cfg_katherine) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
    (r, p_zack, -7), (r, p_david, -6);

  -- Madison Meadow Park - UDisc Scoring
  INSERT INTO rounds (course_config_id) VALUES (cfg_madison) RETURNING id INTO r;
  INSERT INTO scores (round_id, player_id, strokes) VALUES
